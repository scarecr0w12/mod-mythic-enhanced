...
public:
    enum PagedDataType
    {
        ...
        PAGED_DATA_TYPE_MYTHIC_NPC_SUB_RUN,
        PAGED_DATA_TYPE_MYTHIC_NPC_SUB_RANKINGS,
        PAGED_DATA_TYPE_MYTHIC_NPC_SUB_HELP,
        ...
        PAGED_DATA_TYPE_MYTHIC_SEASON_INFO,
        PAGED_DATA_TYPE_MYTHIC_SEASON_ARCHIVE_MENU,
        PAGED_DATA_TYPE_MYTHIC_OVERALL_LEADERBOARD,
        PAGED_DATA_TYPE_MYTHIC_DUNGEON_LIST_LEADERBOARD,
        PAGED_DATA_TYPE_MYTHIC_DUNGEON_MAP_LEADERBOARD,
        PAGED_DATA_TYPE_MYTHIC_HELP_GUIDE,
        MAX_PAGED_DATA_TYPE
    };
